...
const ProfileDetailPage: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center min-h-screen text-brand-600 dark:text-blue-400 font-syne font-bold bg-slate-50 dark:bg-slate-950">
        Loading profile...
      </div>
    )
  }
      ...
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            ...
            className="mt-4 text-brand-600 dark:text-blue-400 font-bold hover:text-blue-700 dark:hover:text-blue-300"
          >
            Back to Discovery
          </button>
        </div>
        ...
        <div className="lg:col-span-5 flex flex-col gap-6 p-6 lg:p-0 pb-24 lg:pb-0">
          {hostListing && (
            ...
            >
              ...
              <span className="text-sm font-medium text-brand-600 dark:text-blue-400 inline-flex items-center gap-1">
