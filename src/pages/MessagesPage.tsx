                ...
                <div
                  ...
                  className={`flex items-center gap-4 p-4 border-b transition-colors cursor-pointer ${
                    isUnread
                      ...
                      : 'bg-white dark:bg-slate-700 hover:bg-slate-50 dark:hover:bg-slate-600/40'
                ...
                >
                  ...
                  >
                    {thread.otherUser?.photoURL ? (
                      ...
                      <div className="w-14 h-14 rounded-full bg-brand-50 dark:bg-brand-900/30 border border-brand-100 dark:border-brand-700/40 flex items-center justify-center text-brand-700 dark:text-brand-200 font-syne font-bold text-lg hover:opacity-80 transition-opacity">
